...
{
    internal sealed class HardwareStatsPrePatcher : ConfiguredEarlyMonkey<HardwareStatsPrePatcher, HardwareStatsConfig>
    {
        ...
        protected override bool Patch(PatchJob patchJob)
        {
            ...
            processor.InsertBefore(engineCCtor.Body.Instructions.First(), processor.Create(OpCodes.Call, typeof(HardwareStatsPrePatcher).GetMethod(nameof(HelloMethod))));
